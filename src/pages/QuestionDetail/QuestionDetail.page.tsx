          ...
          <div className="grid grid-cols-2 gap-x-[180px]">
            <div className="flex flex-col justify-center items-center">
              <div className="flex cursor-pointer">
                <Checkbox onChange={() => onClickCheckbox("optionOne")} inputId="optionOne" value="optionOne"
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="flex cursor-pointer">
                <Checkbox onChange={() => onClickCheckbox("optionTwo")} inputId="optionTwo" value="optionTwo"
